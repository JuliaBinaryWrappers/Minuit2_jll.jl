...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Minuit2_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("683d4edd-6ccf-5a74-985b-ebee5a2d6cb7"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Minuit2", artifacts_toml) for e in artifacts["Minuit2"]]
...
if best_platform === nothing
    @debug("Unable to load Minuit2; unsupported platform $(triplet(platform_key_abi()))")
else
